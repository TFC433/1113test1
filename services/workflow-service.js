...
class WorkflowService {
    ...
    async _createFullOpportunityWorkflow(opportunityData, contactSourceInfo) {
        ...
        const rowData = [
            ...
            /* 12: M */ this.config.CONSTANTS.DEFAULT_VALUES.OPPORTUNITY_STATUS, // <--- [拼字修正]
            /* 13: N */ '', // Drive資料夾連結
            /* 14: O */ now, // 最後更新時間
            ...
            /* 20: U */ opportunityData.potentialSpecification || '', // 可能下單規格
        ...
        const response = await this.sheets.spreadsheets.values.append({
            ...
            range: `${this.config.SHEETS.OPPORTUNITIES}!A:W`, // 確保範圍是 A:W
